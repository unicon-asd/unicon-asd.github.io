...
c.prototype=b.prototype;a.M=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.kl=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.rl;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.za}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
function ng(a){var b=void 0===a?{}:a;a=void 0===b.mb?!1:b.mb;b=void 0===b.Wa?!0:b.Wa;if(null==B("_lact",window)){var c=parseInt(E("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&og();ag(document,"keydown",og);ag(document,"keyup",og);ag(document,"mousedown",og);ag(document,"mouseup",og);a?ag(window,"touchmove",function(){pg("touchmove",200)},{passive:!0}):(ag(window,"resize",function(){pg("resize",200)}),b&&ag(window,"scroll",function(){pg("scroll",200)}));
...
function Gh(){return{innertubeApiKey:E("INNERTUBE_API_KEY",void 0),innertubeApiVersion:E("INNERTUBE_API_VERSION",void 0),Za:E("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),ab:E("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),cb:E("INNERTUBE_CONTEXT_HL",void 0),bb:E("INNERTUBE_CONTEXT_GL",void 0),eb:E("INNERTUBE_HOST_OVERRIDE",void 0)||"",gb:!!E("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),fb:!!E("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
...
function Xh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.jl||E("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().il:b=vd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
...
v(R,yi);function Ii(a){R.call(this,"MISSING_OBJECT_STORE",{ib:a},Di.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Ii.prototype)}
...
dbName:b});if("AbortError"===d.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},d.message);d.args=[{name:"IdbError",ol:d.name,dbName:b,objectStoreNames:c}];d.level="WARNING";return d}
...
pj.prototype.open=function(){function a(){return H(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var A=h.options;for(var J=u(Object.keys(A.ma)),F=J.next();!F.done;F=J.next()){F=F.value;var Q=A.ma[F],V=void 0===Q.Oa?Number.MAX_VALUE:Q.Oa;if(k.h.version>=Q.ea&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(F)){A=F;break a}}A=void 0}l=A;if(void 0===l){p.B(5);break}if(h.j){p.B(6);break}h.j=!0;return w(p,
h.delete(),7);case 7:return wi(new R("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,ib:l})),p.return(a());case 6:throw new Ii(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.B(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,wb:b,upgrade:this.options.upgrade};return this.h=d=a()};var rj=new pj("YtIdbMeta",{ma:{databases:{ea:1}},upgrade:function(a,b){b(1)&&$i(a,"databases",{keyPath:"actualName"})}});
...
;var Mj;
function Nj(){if(Mj)return Mj();var a={};Mj=Lj("LogsDatabaseV2",{ma:(a.LogsRequestsStore={ea:2},a.sapisid={ea:2,Oa:7},a.SWHealthLog={ea:3},a),Ba:!1,upgrade:function(b,c,d){c(2)&&($i(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}),$i(b,"sapisid"));c(3)&&$i(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1});c(5)&&(b=Zi(d,"LogsRequestsStore"),b.h.indexNames.contains("newRequest")&&b.h.deleteIndex("newRequest"),b.h.createIndex("newRequestV2",["status",
...
;var Wj={},Xj=Lj("ServiceWorkerLogsDatabase",{ma:(Wj.SWHealthLog={ea:1},Wj),Ba:!0,upgrade:function(a,b){b(1)&&$i(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
m.jb=function(a){this.l=!0;if(void 0===a?0:a)this.C||hk(this)};
...
U.prototype.sendNetworkCheckRequest=U.prototype.Y;U.prototype.listen=U.prototype.ca;U.prototype.enableErrorFlushing=U.prototype.Ua;U.prototype.getWindowStatus=U.prototype.wa;U.prototype.monitorNetworkStatusChange=U.prototype.jb;U.prototype.isNetworkAvailable=U.prototype.L;U.getInstance=gk;function ik(a){a=void 0===a?{}:a;Me.call(this);var b=this;this.l=this.A=0;this.j=gk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Va);a.hb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.oa?(this.oa=a.oa,c("ytnetworkstatus-online",function(){jk(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){jk(b,"publicytnetworkstatus-offline")})):
...
function sk(){ok||(ok=new ik({hb:!0,Va:!0}));return ok}
...
c.onFetchSuccess=function(F,Q){ci(p);J(F,Q)}}try{r&&d.retry&&!d.Ma.bypassNetworkless?(g.method="POST",!d.Ma.writeThenSend&&O("nwl_send_fast_on_unload")?Bk(q,g):wk(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Og(q,g))}catch(F){if("InvalidAccessError"==F.name)p&&(ci(p),p=0),Of(Error("An extension is blocking network request."));
...
Lk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.nl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Gk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.na[l.name])for(e=u(c.na[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
;var al={jc:3611,yb:27686,zb:85013,Ab:23462,Cb:42016,Db:62407,Eb:26926,Bb:43781,Fb:51236,Gb:79148,Hb:50160,Ib:77504,Ub:87907,Vb:18630,Wb:54445,Xb:80935,Yb:105675,Zb:37521,ac:47786,cc:98349,dc:123695,ec:6827,fc:29434,hc:7282,ic:124448,mc:32276,lc:76278,nc:93911,oc:106531,pc:27259,qc:27262,sc:27263,uc:21759,wc:27107,xc:62936,yc:49568,zc:38408,Ac:80637,Bc:68727,Cc:68728,Dc:80353,Ec:80356,Fc:74610,Gc:45707,Hc:83962,Ic:83970,Jc:46713,Kc:89711,Lc:74612,Mc:93265,Nc:74611,Oc:131380,Pc:128979,Qc:128978,Rc:105350,
Tc:113533,Uc:93252,Vc:99357,Xc:94521,Yc:114252,Zc:113532,bd:94522,Wc:94583,cd:88E3,dd:93253,ed:93254,fd:94387,gd:94388,hd:93255,jd:97424,Sc:72502,kd:110111,ld:76019,nd:117092,od:117093,md:89431,pd:110466,qd:77240,rd:60508,sd:73393,td:113534,ud:92098,vd:131381,wd:84517,xd:83759,yd:80357,zd:86113,Ad:72598,Bd:72733,Cd:107349,Dd:124275,Ed:118203,Fd:117431,Gd:117429,Hd:117430,Id:117432,Jd:120080,Kd:117259,Ld:121692,Md:97615,Nd:31402,Od:84774,Pd:95117,Qd:98930,Rd:98931,Sd:98932,Td:43347,Ud:129889,Vd:45474,
zi:129089,Ai:21409,Bi:11070,Ci:11074,Di:17880,Ei:14001,Gi:30709,Hi:30707,Ii:30711,Ji:30710,Ki:30708,Fi:26984,Li:63648,Mi:63649,Ni:51879,Oi:111059,Pi:5754,Qi:20445,Ri:110386,Si:113746,Ti:66557,Ui:17310,Vi:28631,Wi:21589,Xi:68012,Yi:60480,Zi:31571,aj:76980,bj:41577,cj:45469,dj:38669,ej:13768,fj:13777,gj:62985,hj:4724,ij:59369,jj:43927,kj:43928,lj:12924,mj:100355,pj:56219,qj:27669,rj:10337,oj:47896,sj:122629,tj:121258,uj:107598,vj:127991,wj:96639,xj:107536,yj:130169,zj:96661,Aj:96658,Bj:116646,Cj:121122,
Dj:96660,Ej:127738,Fj:127083,Gj:104443,Hj:96659,Ij:106442,Jj:63667,Kj:63668,Lj:63669,Mj:130686,Nj:78314,Oj:55761,Pj:127098,Qj:96368,Rj:67374,Sj:48992,Tj:49956,Uj:31961,Vj:26388,Wj:23811,Xj:5E4,Yj:126250,Zj:96370,ak:47355,bk:47356,ck:37935,dk:45521,ek:21760,fk:83769,gk:49977,hk:49974,ik:93497,jk:93498,kk:34325,lk:115803,mk:123707,nk:100081,pk:35309,qk:68314,rk:25602,sk:100339,tk:59018,uk:18248,vk:50625,wk:9729,xk:37168,yk:37169,zk:21667,Ak:16749,Bk:18635,Ck:39305,Dk:18046,Ek:53969,Fk:8213,Gk:93926,
Hk:102852,Ik:110099,Jk:22678,Kk:69076,Mk:100856,Nk:17736,Ok:3832,Pk:55759,Qk:64031,Rk:93044,Sk:93045,Tk:34388,Uk:17657,Vk:17655,Wk:39579,Xk:39578,Yk:77448,Zk:8196,al:11357,bl:69877,dl:8197,fl:82039};function bl(){var a=kb(cl),b;return cf(new We(function(c,d){a.onSuccess=function(e){Ig(e)?c(new dl(e)):d(new el("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var tl,ul=y.ytLoggingDocDocumentNonce_;ul||(ul=sl(),Ra("ytLoggingDocDocumentNonce_",ul));tl=ul;var vl={qe:0,kc:1,tc:2,wh:3,se:4,Lk:5,ki:6,nj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function wl(a){this.h=a}
...
un.prototype.D=function(){window.removeEventListener("message",this.A);L.prototype.D.call(this)};function vn(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new un(!!E("WIDGET_ID_ENFORCE")),b=this.nb.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
m=vn.prototype;m.nb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,wn(this,a)),this.j[a]=!0)):this.Ca(a,b,c)};
m.Ca=function(){};
...
;function Qn(a,b,c,d){L.call(this);var e=this;this.G=b;this.webPlayerContextConfig=d;this.qa=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.O=this.ga=this.elementId=this.ra=this.config=null;this.N=!1;this.l=this.A=null;this.ha={};this.Qa=["onReady"];this.lastError=null;this.Da=NaN;this.C={};this.Ra=new Jn(this);this.aa=0;this.j=this.u=a;Xd(this,Qa(Vd,this.J));Rn(this);Sn(this);Xd(this,Qa(Vd,this.Ra));c?this.aa=dg(function(){e.loadNewVideoConfig(c)},0):d&&(Tn(this),Un(this))}
...
m.addEventListener=function(a,b){var c=this,d=Xn(this,b);d&&(0<=Wa(this.Qa,a)||this.i[a]||(b=io(this,a),this.m&&this.m(a,b)),this.J.subscribe(a,d),"onReady"===a&&this.isReady()&&dg(function(){d(c.api)},0))};
